...
#pragma config(Motor,  mtr_S1_C2_1,     motorG,        tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C2_2,     motorJ,        tmotorTetrix, openLoop)
...
#pragma config(Servo,  srvo_S2_C1_1,    claw,                 tServoNone)
